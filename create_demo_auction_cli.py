#!/usr/bin/env python3
"""
Demo Auction Creator - CLI Version
...
Usage:
    python create_demo_auction_cli.py <account_id> <api_key>
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python create_demo_auction_cli.py <account_id> <api_key>")
        print("\nExample:")
        print("  python create_demo_auction_cli.py acc_123456 sk_abcdef123456")
        sys.exit(1)
